...
def ice_break(name: str) -> Tuple[PersonIntel, str]:
    ...
    person = chain.invoke(input={"linkedin_information": linkedin_data})
    parsed_person = person_intel_parser.parse(person["text"])
    profile_pic_url = linkedin_data.get("profile_pic_url")

    return parsed_person, profile_pic_url


if __name__ == "__main__":
    print("Hello LangChain!")
    result, url = ice_break(name="Harrison Chase")
    print(result)
